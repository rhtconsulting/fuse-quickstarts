...
public class RouteOneIntegrationTest {

    private static final Set<String> INCLUDED_ROUTE_GROUPS = Collections.singleton("camelXmlRoutes");
    ...
    @Test
    public void testRouteOne_Success() throws Exception {
        // Replace the timer with a direct component "from"
        camelContext.getRouteDefinition("routeOne")
