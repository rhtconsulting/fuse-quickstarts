...
public class ProducerRouteTest extends CamelTestSupport {
    ...
    public void setUp() throws Exception {
        replaceRouteFromWith("eapJmsProducer", "direct:timer");
        super.setUp();
    }
    ...
    public void testProduceMessageRoute() throws Exception {
        // Get Mocks
        MockEndpoint outgoingMsg = getMockEndpoint("mock:direct:eapJmsProducer");
        MockEndpoint jmsEndpoint = getMockEndpoint("mock:jms:queue:eapJmsTestQueue");
